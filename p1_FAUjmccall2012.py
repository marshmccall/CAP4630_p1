...
class Checker(TwoPlayerGame):
    ...
    def lose(self):
        ...
        """if self.player[1].pos[0][1] == 'W' or self.player[1].pos[0][3] == 'W' or self.player[1].pos[0][5] == 'W' or self.player[1].pos[0][7] == 'W':
            return True
        if self.player[0].pos[7][0] == 'B' or self.player[0].pos[7][2] == 'B' or self.player[0].pos[7][4] == 'B' or self.player[0].pos[7][6] == 'B':
            return True
        else:
            return False"""

        for wpos in self.players[0].pos:
            if wpos in self.black_territory:
                self.won="white"
                return True

        for bpos in self.players[1].pos:
            if bpos in self.white_territory:
                self.won="black"
                return True
